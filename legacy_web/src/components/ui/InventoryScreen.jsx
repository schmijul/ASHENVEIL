...
export default function InventoryScreen() {
  ...
  const capacity = useInventoryStore((state) => state.capacity);
  const getItemDefinition = useInventoryStore((state) => state.getItemDefinition);
  const equipItemById = useInventoryStore((state) => state.equipItemById);
  const unequipItem = useInventoryStore((state) => state.unequipItem);
  const resolveEquipmentSlot = useInventoryStore((state) => state.resolveEquipmentSlot);
